...
class OTelPinoStream extends stream_1.Writable {
    ...
    _write(s, _encoding, callback) {
        ...
        const { time, [this._messageKey]: body, [this._errorKey]: exception, level, // eslint-disable-line @typescript-eslint/no-unused-vars
...
function normalizeException(exception) {
    ...
    if (typeof exceptionObject['type'] === 'string' &&
