...
declare namespace errors_d_exports {
  export { ErrCode, OutgoingResultError, SerializedError$1 as SerializedError, deserializeError, fixEventKeyMissingSteps, getErrorMessage, isSerializedError, rethrowError, serializeError };
}
