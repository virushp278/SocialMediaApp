...
type TokenTopics<TTopics extends readonly string[] | undefined = readonly string[] | undefined> = TTopics extends readonly string[] ? [...TTopics] : string[];
type TokenFactory<TChannel extends Realtime.ChannelInput = Realtime.ChannelInput, TTopics extends readonly string[] | undefined = readonly string[] | undefined> = () => Promise<string | ClientSubscriptionToken | Realtime.Subscribe.Token<TChannel, TokenTopics<TTopics>>>;
...
interface UseRealtimeOptions<TChannel extends Realtime.ChannelInput = Realtime.ChannelInput, TTopics extends readonly string[] | undefined = readonly string[] | undefined> {
  channel?: TChannel;
  topics?: TTopics;
  token?: ClientSubscriptionToken | Realtime.Subscribe.Token<TChannel, TokenTopics<TTopics>> | TokenFactory<TChannel, TTopics>;
  key?: string;
  enabled?: boolean;
