        ...
        <div>
          <div className='flex items-center gap-3 mb-4 max-md:mt-10'>
            ...
            <div>
              ...
              <p>Used by 12k+ developers worldwide</p>
            </div>
          </div>
          ...
          <p className='text-x1 md:text-3xl text-indigo-900 max-w-72 md:max-w-md'> connect with our global community on socialix.</p>
        </div>
